...
const experienceData: ExperienceData[] = [
  {
    ...
    description: [
      ...
      'Deployed and managed containerized microservices using Docker and Azure Kubernetes Service (AKS), reducing deployment time by 40% and improving scalability for 20+ services',
